...
# define model paths
graph_file = "models/MSL_GBR_Vindija_step1/MSL_GBR_Vindija_model.yaml"
...
output_file = "models/MSL_GBR_Vindija_step1/MSL_GBR_Vindija_model.misid_fit.yaml"
...
moments.Plotting.plot_1d_comp_Poisson(
    ...
    out="models/MSL_GBR_Vindija_step1/MSL_GBR_Vindija_model.misid_fit.comp_1d_MSL.png"
)

# plot marginal fit for GBR
moments.Plotting.plot_1d_comp_Poisson(
    model.marginalize([0, 2]), data.marginalize([0, 2]), residual="Anscombe", 
    out="models/MSL_GBR_Vindija_step1/MSL_GBR_Vindija_model.misid_fit.comp_1d_GBR.png"
)

# plot 3-way comparison
moments.Plotting.plot_3d_comp_Poisson(
    model, data, residual="Anscombe", 
    out="models/MSL_GBR_Vindija_step1/MSL_GBR_Vindija_model.misid_fit.comp_3d.png"
)
