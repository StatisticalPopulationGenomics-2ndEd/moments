...
def main():
    ...
    plt.savefig("MSL_GBR_Vindija_round3.misid_fit.tubes_logtime.png")
    plt.close()
    ax = plt.subplot(111)
    demesdraw.tubes(graph, ax=ax)
    plt.savefig("MSL_GBR_Vindija_round3.misid_fit.tubes.png")
    plt.close()
    ...
    moments.Plotting.plot_1d_comp_Poisson(
        ...
        residual="linear", 
        out="MSL_GBR_Vindija_round3.misid_fit.comp_1d_GBR.png"
    )
    # and for MSL
    moments.Plotting.plot_1d_comp_Poisson(
        ...
        residual="linear", 
        out="MSL_GBR_Vindija_round3.misid_fit.comp_1d_MSL.png"
    )
    ...
    moments.Plotting.plot_3d_comp_Poisson(
        ...
        data, 
        residual="linear", 
        out="MSL_GBR_Vindija_round3.misid_fit.comp_3d.png"
    )
